        ...
        <AnimatedSection delay={0.2}>
          <Card className="max-w-2xl mx-auto border-white/10 overflow-visible"
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-white/40 mb-6">Main Auditorium & Computer Science Block</p>
              ...
              >
                <div className="p-8 flex flex-col items-center gap-4 text-center">
                  <Avatar className="w-28 h-28 shrink-0" style={{ border: `3px solid ${person.color}50` }}>
                    {person.photo && <AvatarImage src={person.photo} alt={person.name} className="object-cover" style={person.name.includes("Jaswinder") ? { objectPosition: "center 15%" } : person.name.includes("Dashmeet") ? { objectPosition: "center 10%" } : undefined} />}
                    <AvatarFallback
